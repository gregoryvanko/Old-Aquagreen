class Config{
    ...
    ClearView(){
        ...
        GlobalAddActionInList("Refresh", this.BuildViewConfig.bind(this))
        // Clear view
...
let ConfigApp = new Config(GlobalCoreXGetAppContentId())
// Ajout de l'application 1
GlobalCoreXAddApp(ConfigApp.GetTitre(), ConfigApp.GetImgSrc(),ConfigApp.BuildViewConfig.bind(ConfigApp))