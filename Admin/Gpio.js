class Gpio{
    ...
    RelayConfigGpio(Conteneur, config){
        ...
        DivNumber.appendChild(CoreXBuild.DivTexte("Number","","Text","margin: 1%;"))
        ...
        DivSelectName.appendChild(CoreXBuild.DivTexte("Name","","Text","margin: 1%;"))
        ...
        DivSelectTimeOut.appendChild(CoreXBuild.DivTexte("TimeOut","","Text","margin: 1%;"))
    ...
    ButtonConfigGpio(Conteneur, config){
        ...
        DivSelectNumber.appendChild(CoreXBuild.DivTexte("Number","","Text","margin: 1%;"))
        let InputNumber = CoreXBuild.Input("GpioNumber",GpioNumer,"Input","","text","GpioNumber","Set GPIO Number")
        InputNumber.style.width= "50%"
        ...
        DivSelectTimeOut.style.marginBottom= "2%";
        Conteneur.appendChild(DivSelectTimeOut)
        DivSelectTimeOut.appendChild(CoreXBuild.DivTexte("Debounce Timeout","","Text","margin: 1%;"))
